...
<div class="side-header show">
    ...
    <div class="side-header-inner custom-scroll">
        <nav class="side-header-menu" id="side-header-menu">
            <ul>
                <li><a href="{{ route('ins.home') }}"><i class="bx bx-home"></i> <span>Home</span></a></li>

                <li class="has-sub-menu"><a href="#"><i class="bx bxs-report"></i>
                        <span>Reports</span></a>
                    <ul class="side-header-sub-menu">
                        @if ($canWrite)
                            <li><a href="{{ url('/ins-dept/add-report') }}"><span>Add New Report</span></a></li>
                        @endif

                        <li><a
                                href="{{ route('ins.report', ['type' => 'installation']) }}"><span>Installation</span></a>
                        </li>
                        <li><a
                                href="{{ route('ins.report', ['type' => 'uninstallation']) }}"><span>Uninstallation</span></a>
                        </li>
                    </ul>
                </li>
